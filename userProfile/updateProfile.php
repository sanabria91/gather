...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <title>Update Profile | Gather</title>
</head>
<body>
...
<div class="container">
    ...
    <form action="updateProfile.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group" id="formrow1">
            ...
            <input type="date" id="user_dob" name="user_dob" class="form-control" value="<?php echo $results['user_dob']; ?>">
        </div>

        <div class="form-group" id="formrow1.5">
            <label class="address_label">Address: </label>
            <input type="text" class="form-control" id="address" name="address" placeholder="ex: 883 Drysdale Drive, Mississauga ON, L5V 1X5" value="<?php echo $results['address']; ?>">
        </div><!--formrow1-->
        <div class="form-group" id="formrow2">
            <label class="education_level_label">Highest Education: </label>
            <input type="text" class="form-control" id = "education_level" name="education_level" placeholder="ex. Postgraduate Diploma in Web Development" value="<?php echo $results['education_level']; ?>">
        </div>
        <div class="form-group" id="formrow2.5">
            <label class="current_jobtitle_label">Current Job Title: </label>
            <input type="text" class="form-control" id = "current_jobtitle" name="current_jobtitle" placeholder="ex. Strategy Assistant at Starcom Mediavest" value="<?php echo $results['current_jobtitle']; ?>">
        </div><!--formrow2-->
        <div class="form-group" id="formrow4">
            ...
            <textarea name="user_description" class='form-control' value="<?php echo $results['user_description']; ?>" id="user_description" rows="5" placeholder="Must be between 300 and 1000 characters"><?php echo $results['user_description']; ?></textarea>
            <!--            <input type="text" class="tbbig" class="user_description" id="user_description" name="user_description" rows="2" cols="50" placeholder="Must be between 300 and 1000 characters" value="--><?php //echo $results['user_description']; ?><!--"-->
        </div><!--formrow4-->
        <br><br>
        ...
        <br><br>
        <input type="submit" class="btn btn-success btn-lg" value="Update Your Profile" name="updateProfileButton"/>
    </form>
    <br><br>
...
<!--            <label class="address_label">Address: </label>-->
<!--            <input type="text" class="tb" id="address" name="address" placeholder="ex: 883 Drysdale Drive, Mississauga ON, L5V 1X5" value="--><?php //echo $results['address']; ?><!--">-->
<!--        </div><!--formrow1-->-->
<!--        <br><br>-->
<!--        <div class="row col-lg-12 col md-12  col-sm-12 col-xs-12" id="formrow2">-->
<!--            <label class="education_level_label">Highest Education: </label>-->
<!--            <input type="text" class="tb" id = "education_level" name="education_level" placeholder="ex. Postgraduate Diploma in Web Development" value="--><?php //echo $results['education_level']; ?><!--">-->
<!--        </div>-->
<!--        <br><br>-->
<!--        <div class="row col-lg-12 col md-12  col-sm-12 col-xs-12" id="formrow2.5">-->
<!--            <label class="current_jobtitle_label">Current Job Title: </label>-->
<!--            <input type="text" class="tb" id = "current_jobtitle" name="current_jobtitle" placeholder="ex. Strategy Assistant at Starcom Mediavest" value="--><?php //echo $results['current_jobtitle']; ?><!--">-->
<!--        </div><!--formrow2-->-->
<!--        <br><br>-->
...
<!--        </div><!--formrow5-->-->
<!--        <br><br>-->
<!--        <input type="submit" class="btn-success" value="Update Your Profile" name="updateProfileButton"/>-->
<!--    </form>-->
<!--    <br><br>-->
<!---->
<!--    <script>-->
