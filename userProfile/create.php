...
<head>
    ...
    <link rel="stylesheet" href='<?php echo __httpRoot . "assest/"; ?>profileStylsheet.css'>
    <?php include(__root."views/components/globalhead.php"); ?>
    <!--    <link rel="stylesheet" href='--><?php //echo __httpRoot . "assest/"; ?><!--style/profileStylsheet.css'>-->

    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <title>Create Profile | Gather</title>
</head>
<body>
<?php include(__root."views/components/userheader.php"); ?>
<div class="container">
    <br><br>
    <h2 class="page-header">Hello <span id="uName"><?php echo $usersDetails['username']?></span> <br> Please fill out the form below to create your profile.</h2>
    ...
    <form action="create.php" method="post" name="mainForm" enctype="multipart/form-data"><!--enctype means for image upload-->
        ...
        <div class="form-group" id="formrow4">
            ...
            <textarea name="user_description" class='form-control' value="<?php echo htmlspecialchars($user_description); ?>" id="user_description" rows="5" placeholder="Must be between 300 and 1000 characters"></textarea>
