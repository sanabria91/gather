    ...
    if(isset($_POST["subbtn"])) {
        if(isset($_POST['CategoryTitle']) && isset($_POST['CategoryDescription'])) {
            ...
            if(($category != null) && ($category->getTitle() != null) && ($category->getDescription() != null) ) {
                $result = $categoryConnect->createCategory($category);
            } 
...
<div class="container">
    ...
    <form action="Create.php" method="POST">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="" placeholder="Title" name="CategoryTitle">
        </div>
        <div class="form-group">
            <label for="CategoryDescription">Category Description</label>
            <textarea class="form-control" id="" name="CategoryDescription"></textarea>
        </div>
